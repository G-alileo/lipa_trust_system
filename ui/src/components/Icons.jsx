...
export function IconCampaign({ size = 24, className = "" }) {
  return (
    <svg {...iconProps} width={size} height={size} className={className}>
...
export function IconVerified({ size = 24, className = "" }) {
  return (
    <svg {...iconProps} width={size} height={size} className={className}>
...
export function IconTrending({ size = 24, className = "" }) {
  return (
    <svg {...iconProps} width={size} height={size} className={className}>
...
export function IconRefund({ size = 24, className = "" }) {
  return (
    <svg {...iconProps} width={size} height={size} className={className}>
...
export function IconLogout({ size = 24, className = "" }) {
  return (
    <svg {...iconProps} width={size} height={size} className={className}>
...
export function IconChevronUp({ size = 24, className = "" }) {
  return (
    <svg {...iconProps} width={size} height={size} className={className}>
...
export function IconMpesa({ size = 24, className = "" }) {
  return (
