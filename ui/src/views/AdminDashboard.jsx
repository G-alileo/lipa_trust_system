    ...
    return (
      <div className="admin-view">
        <div className="admin-header" style={{ marginBottom: "3rem" }}>
          ...
          <p className="muted">
            Review pending campaigns before they appear on the public
            marketplace.
          </p>
        </div>
                ...
                <tbody>
                  {pending.length === 0 ? (
                    <tr>
                      ...
                      >
                        <p className="muted">
                          No pending campaigns for review. Good job!
                        </p>
                      </td>
                    </tr>
                  ) : (
                      ...
                      >
                        <td style={{ padding: "1.5rem 1rem" }}>
                          ...
                          <div className="muted" style={{ fontSize: "0.8rem" }}>
                            By Owner ID: {c.owner_id}
                          </div>
                        </td>
                        <td style={{ padding: "1rem" }}>
                          KES {Number(c.target_amount).toLocaleString()}
                        </td>
